    ...
    <div class="">
        <div class="collapse" id="addCourse">
            <div class="d-flex flex-column min-vh-100 max-vw-80 justify-content-space-between align-items-center">
                <div class="row g-3">
                    <div class="col-md-6">
                        <button type="button" class="btn btn-primary m-3" data-bs-toggle="modal" data-bs-target="#deps">
                            Departments
                        </button>
                    </div>
                    <div class="col-md-6">
                        <button type="button" class="btn btn-primary m-3" data-bs-toggle="modal" @click="updateCourses()" data-bs-target="#courses">
                            Courses
                        </button>
                    </div>
                </div>
                <div class="modal fade deps" id="courses" tabindex="-1">
                ...
                <div class="modal fade deps" id="deps" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <form @submit="submit($event)">
                                <div class="row g-3 m-5">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input type="number" name="dep" class="form-control" id="dep"
    ...
    export default {
        ...
        methods:{
            ...
            async submit(e){
                ...
                e.preventDefault();
                this.error = 1;
                let res = await Sections.insertCourse(courseData);
                console.log(res);
                if(res.rows.length){
                    this.error = -1;
                }
